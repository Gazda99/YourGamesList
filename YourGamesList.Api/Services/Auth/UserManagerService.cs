...
public class UserManagerService : IUserManagerService
{
    ...
    private readonly IUserManagerServiceTelemetry _userManagerServiceTelemetry;
    ...
    public UserManagerService(
        ...
        IUserManagerServiceTelemetry userManagerServiceTelemetry
    )
    {
        _logger = logger;
        ...
        _userManagerServiceTelemetry = userManagerServiceTelemetry;
    ...
    public async Task<CombinedResult<string, UserAuthError>> Login(string username, string password)
    {
        ...
        {
            _logger.LogInformation("Username is null or empty.");
            _userManagerServiceTelemetry.TrackFailedLogin(nameof(UserAuthError.InvalidUsername));
        ...
        {
            _logger.LogInformation("Password is null or empty.");
            _userManagerServiceTelemetry.TrackFailedLogin(nameof(UserAuthError.WrongPassword));
        ...
        if (findUser.IsFailure)
        {
            ...
            _userManagerServiceTelemetry.TrackFailedLogin(nameof(UserAuthError.NoUserFound));
        ...
        _userManagerServiceTelemetry.TrackSuccessfulLogin();
